...
public class Quote {
	...
	public Quote(int quoteId, @NotEmpty(message = "premiumType should not be empty") String premiumType,
			@NotNull @Min(100000) @Max(10000000) double premium,
			@NotNull @Min(15000) @Max(10000000) double dwellingCoverage,
			...
			@NotNull @Min(15000) @Max(10000000) double additionalLivingExpense,
			@NotNull @Min(15000) @Max(10000000) double medicalExpense,
